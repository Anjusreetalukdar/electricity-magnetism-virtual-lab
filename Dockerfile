...
# Usage: Installing dependencies for electricity-magnetism-virtual-lab
RUN apt-get install -y make rsync apache2 wget php5

RUN mkdir /electricity-magnetism-virtual-lab

COPY src/ /electricity-magnetism-virtual-lab/src

WORKDIR ./electricity-magnetism-virtual-lab/src
